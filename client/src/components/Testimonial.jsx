          ...
          <div className="marquee-inner flex items-stretch min-w-[200%] py-6 gap-4 px-2">
            {marqueeItems.map((review, idx) => {
              ...
              return (
                <div
                  key={`${review._id}-${idx}`}
                  className="flex flex-col justify-between p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 w-72 sm:w-80 shrink-0 bg-white"
                >
                  {/* User */}
                  <div className="flex gap-3 items-center">
                    {userImage ? (
                      ...
                      <div className="w-10 h-10 rounded-full bg-slate-200 flex items-center justify-center ring-2 ring-gray-100">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-1">
                        ...
                        {/* Verified badge */}
                        <svg className="shrink-0 fill-blue-500" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <span className="text-xs text-slate-400 truncate block" title={location}>{location}</span>
                    </div>
                  </div>
                  ...
                  {/* Comment */}
                  <p className="text-sm mt-3 text-gray-700 leading-relaxed line-clamp-4">
                    {review.comment}
                  </p>
