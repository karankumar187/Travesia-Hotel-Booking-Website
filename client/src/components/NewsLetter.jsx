      ...
      <div className="w-full bg-slate-900 text-center text-white py-10 sm:py-12 md:py-14 px-4 sm:px-6 md:px-8 rounded-xl sm:rounded-2xl shadow-lg">
        ...
        <p className="text-gray-500 text-xs sm:text-sm mt-2 sm:mt-3 px-2">
          ...
          <form 
            ...
            className="flex flex-col sm:flex-row items-stretch sm:items-center mt-6 sm:mt-8 md:mt-10 border border-slate-700 rounded-full sm:h-13 max-w-lg w-full mx-auto bg-slate-800/40 backdrop-blur-sm overflow-hidden"
          >
            <input
              type="email"
              value={email}
            ...
            <button type="submit" className="bg-black hover:bg-gray-800 transition-all text-white rounded-full sm:h-11 h-12 sm:mr-1 px-5 sm:px-7 text-xs sm:text-sm flex items-center justify-center group cursor-pointer z-10">
              Subscribe
            <img
