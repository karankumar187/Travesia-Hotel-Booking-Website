...
export default function FeaturedDestination(){
    ...
    return rooms.length > 0 &&(
        <div className="flex flex-col items-center px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 bg-slate-50 py-8 sm:py-10 md:py-12">
            ...
            className="my-10 sm:my-12 md:my-16 px-4 py-2 text-xs sm:text-sm font-medium border border-gray-300 rounded bg-white hover:bg-gray-50 transition-all cursor-pointer">
